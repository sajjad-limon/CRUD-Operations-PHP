    ...
    <div class="row">
        <div class="col-md-2 sidebar pd0">
            ...
            <ul>
                ...
                <li><a href="all-user.php"><i class="fa fa-user-circle"></i>All User</a></li>
                <li><a href="view-user.php"><i class="fa fa-gamepad"></i> View User</a></li>
                <li><a href="add-user.php"><i class="fa fa-image"></i> Add User</a></li>
